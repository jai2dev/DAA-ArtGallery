"""
Art Gallery Problem 
Provides functionality to solve the Art Gallery problem using Triangulation and Edge Detection
"""
import pygame, sys
...
def displayLabel1(labelMsg):
    ...
    :return:
    """
    gfxdraw.filled_polygon(screen,[[0, WINDOW_HEIGHT - 30], [0, WINDOW_HEIGHT - 16], [WINDOW_WIDTH, WINDOW_HEIGHT - 16],
